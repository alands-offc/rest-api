...
export default async function image(req, res, User) {
    ...
    <table>
        <tr>
            ...
            <th>URL</th>
                ...
                <tr>
            <td>Remini foto url</td>
            <td>GET</td>
            <td><a href="/api/image/remini?url=https://telegra.ph/file/a7e3f488f4abec257234b.jpg&apikey=${apikey}">check</a></td>
        </tr>
    </table>
</div>
