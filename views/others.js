export default async function others(req, res, User) {
...
<div class="box">
    ...
    <table>
        ...
        <tr>
            <td>Tiktok stalk</td>
            <td>GET</td>
            <td><a href="/api/others/tiktokstalk?username=enzet&apikey=${apikey}">check</a></td>
        </tr>
                    <td>mcpedl list</td>
            <td>GET</td>
            <td><a href="/api/others/mcpedl?page=1&apikey=${apikey}">check</a></td>
        </tr>
        </tr>
        <tr>
          <td>cekkodam</td>
          <td>GET</td>
          <td><a href="/api/others/check kodam?username=alan&apikey=${apikey}">check</a></td>
        </tr>
    </table>
</div>
