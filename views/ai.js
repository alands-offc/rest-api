export default async function ai(req, res, User) {
...
<div class="box">
    ...
    <table>
        <tr>
          ...
          <td>gpt-3.5-turbo</td>
          <td>GET</td>
          <td><a href="/api/ai/gpt-3.5-turbo?text=hai&apikey=${apikey}">check</a></td>
        </tr>
                <tr>
          <td>gpt-3.5-turbo sessions (premium)</td>
          <td>GET</td>
          <td><a href="/api/ai/gpt-3.5-turbo-sesi?text=apa+pesan+ku+sebelumnya&nama=alan&id=randomid&apikey=${apikey}">check</a></td>
        </tr>
    </table>
</div>
